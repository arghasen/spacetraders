...
impl ShipFrame {
    ...
    pub fn new(symbol: Symbol, name: String, description: String, condition: f64, integrity: f64, module_slots: i32, mounting_points: i32, fuel_capacity: i32, requirements: models::ShipRequirements, quality: f64) -> ShipFrame {
        ShipFrame {
            symbol,
            name,
            description,
